		...
		for (Player all : Bukkit.getOnlinePlayers()) {
			if(all.isOnline()) {
				...
				if(gameManager.isRunning()) {
					...
					sb.getTeam("e").setPrefix("�8� �b" + gameManager.getMap());
					sb.getTeam("e").setSuffix(" �7(" + bedWars.getFileUtils().getConfigString("Settings.GameFormat") + ")");
					sb.getTeam("b").setPrefix("�8� �b" + Bukkit.getOnlinePlayers().size() + "�7/�b" + (gameManager.getTeams().size() * gameManager.getTeams().get(0).getTeamSize()));
				}
